...
import historyvid from '../assets/History.mp4'

function OurHistory() {
  return (
    <div className='w-[100%] relative h-screen overflow-hidden '>
      ...
      <div className='w-full absolute lg:left-10 lg:bottom-10 left-4 bottom-10 z-10 flex flex-col items-start justify-center gap-4 p-2'>
        ...
        <button className='w-[8rem] h-[2rem]  lg:w-[10rem] lg:h-[3rem] bg-black text-white font-bold rounded-lg text-[1rem]'>Check Out </button>
      </div>
    </div>
  )
}
