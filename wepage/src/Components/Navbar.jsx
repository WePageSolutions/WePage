...
export default function Navbar() {
    ...
    return <nav className="bg-white shadow-lg w-[96%]  h-[4.5rem] flex-row flex fixed top-[2rem] mx-[2%]" ref={myref}>
        <div className="relative  flex-row hidden lg:flex h-[100%] w-[24rem] justify-between items-center">
        ...
        <div className="block lg:hidden my-[1rem] cursor-pointer" onClick={hammenu}>
            <div className="w-[30px] h-[2px] rounded-[10%] bg-black my-[0.5rem]"></div>
            <div className="w-[30px] h-[2px] rounded-[10%] bg-black my-[0.5rem]"></div>
            <div className="w-[30px] h-[2px] rounded-[10%] bg-black my-[0.5rem]"></div>
        </div>
        <img src={logo} className="w-[10rem] h-[100%] absolute lg:left-[48%] md:left-[43%] left-[35%]"></img>
